...
def push_cached_num_microbatches(incoming_num_micro_batch, incoming_cp_sizes):
    assert isinstance(_GLOBAL_NUM_MICROBATCHES_CALCULATOR, CachedNumMicroBatches)
    _GLOBAL_NUM_MICROBATCHES_CALCULATOR.update_cache(incoming_num_micro_batch, incoming_cp_sizes)
